...
// Gleiches Gateway-Muster wie E:\vereinskalender\db.js — reines Gateway ohne
// lokalen Datei-Modus. Anders als beim Vereinskalender gibt es hier KEINE
// Datei-Anhänge/Teilen-Funktion (bewusst schlanker Scope, siehe CLAUDE.md),
// daher fehlen gatewayUploadFile/-FetchFileBlob/-DeleteFile/fetchDirectory.
const GATEWAY_URL = "https://landingpage.michel-brunner.workers.dev";
const TOKEN_STORAGE_KEY = "tu_session_token";
const GATEWAY_APP_ID = "abwesenheitskalender";
...
// Nur für den Bearbeiter-Vollzugriffspfad relevant (siehe app.js persistAbwesenheiten) —
// der Selbstbedienungs-Pfad für Nicht-Bearbeiter braucht kein rev, der Worker mergt dort
// immer frisch (admin-worker.js OWNER_WRITE_APPS/handleOwnerFilteredSave).
let gatewayRev = null;
